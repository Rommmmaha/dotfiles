...
hl.bind("mouse:275", hl.dsp.exec_cmd("r_multitool ptt"), { ignore_mods = true })
hl.bind("mouse:275", hl.dsp.exec_cmd("r_multitool mute"), { ignore_mods = true, release = true })
hl.bind("XF86Mail", hl.dsp.exec_cmd("r_env GROQ_API_KEY -- r_multitool stt | wtype -d 10 -"))
hl.bind("XF86Mail", hl.dsp.exec_cmd("r_multitool mute"), { release = true })
